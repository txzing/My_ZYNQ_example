...
HD_PWD='C:/Users/txzing/Desktop/micro_7020/system_wrapper/vivado_proj/vivado_proj.runs/system_AXI_LITE_REG_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_AXI_LITE_REG_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_AXI_LITE_REG_0_0.tcl
