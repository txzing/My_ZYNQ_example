...
HD_PWD='C:/work/library_of_hdmi/axis_passthrough_mon/axis_passthrough_mon.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_passthrough_mon.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_passthrough_mon.tcl
