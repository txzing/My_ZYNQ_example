...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../vivado_proj.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../vivado_proj.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../vivado_proj.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../vivado_proj.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"D:/Vivado/Vivado/2020.2/data/xilinx_vip/include"
}
